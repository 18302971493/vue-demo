      ...
      <Row type="flex" justify="space-between" class="code-row-bg">
        <Col :span="span">
          ...
          <Row class="operation">
            ...
            <Button @click="test" type="primary" icon="md-add">富文本测试</Button>
            ...
            return h("div", [
              h(
                "Button",
                {
                  ...
                  style: {
                    marginRight: "5px",
                    display:(!this.$route.meta.permission.includes('edit'))?"none":"inline-block",
                  },
                  on: {
                    click: () => {
              ...
              h(
                "Button",
                {
                  ...
                  style:{
                    display:(!this.$route.meta.permission.includes('delete'))?"none":"inline-block",
                  },
                  on: {
                    click: () => {
