  ...
  <div class="search">
    <Row>
      <Col>
        <Card>
          <Row class="operation">
            <Button @click="addRole" type="primary" icon="md-add">添加</Button>
      ...
      <Form ref="form" :model="form" :label-width="80" :rules="formValidate">
        <FormItem label="任务类名" prop="jobClassName">
          <Input
            ...
            placeholder="例如 com.ytain.config.quzrtz.Job"
            clearable
          />
        </FormItem>
...
<script>
  ...
  import circleLoading from "@/components/my-components/circle-loading.vue";
  export default {
    name: "quartz-manage",
    components: {
      circleLoading
